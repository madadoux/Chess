...
namespace Chess
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        string deadpiecesw;
        string deadpiecesb;
        Vector2 deadwposition;
        Vector2 deadbposition;
        Vector2 whitedeathpos;
        Vector2 blackdeathpos;
        ...
        protected override void Initialize()
        {
            ...
            deadpiecesb = "Died pieces:";
            deadpiecesw = "Died pieces:";
            // mada sys
            scorePanleContainer = new Rectangle(440, 0, 160, 440);

            StringButtons.Add(ch.player1, new stringBtn("Player1 ", new Vector2(440,310), Color.White));
            StringButtons.Add(ch.player2, new stringBtn("Player2", new Vector2(440,10), Color.White));
            StringButtons.Add(ch.reset, new stringBtn("Reset ", new Vector2(450,200), Color.White));
            StringButtons.Add(ch.quit, new stringBtn("Quit ", new Vector2(450,230), Color.White));

            StringButtons[ch.quit].onClicked = () => quite();
            StringButtons[ch.reset].onClicked = () => reset();

            PVSPPosition = new Vector2(120, 40);
            PVSCPosition = new Vector2(120, 355);
            deadbposition = new Vector2(440, 40);
            deadwposition = new Vector2(440, 340);
            blackdeathpos = new Vector2(565, 40);
            whitedeathpos = new Vector2(565, 340);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            if (gameState == GameStates.mainscreen)
            {
                ...
                spriteBatch.Draw(
                    ...
                    MainScreen,
                    Color.White);
                spriteBatch.DrawString(font, PVSP, PVSPPosition, Color.Yellow);
                spriteBatch.DrawString(font, PVSC, PVSCPosition, Color.Red);
                spriteBatch.End();
            }
            if (gameState == GameStates.ChoosingMenu)
            {
            ...
            if (gameState == GameStates.White || gameState == GameStates.Black)
            {
                ...
                board.Draw();
                drawScorepanel();
                spriteBatch.DrawString(font2, deadpiecesw, deadwposition, Color.White);
                spriteBatch.DrawString(font2, board.whitedeath.ToString(), whitedeathpos, Color.White);
                spriteBatch.DrawString(font2, board.blackdeath.ToString(), blackdeathpos, Color.Black);
                spriteBatch.DrawString(font2, deadpiecesb, deadbposition, Color.Black);
                spriteBatch.End();
            }
            base.Draw(gameTime);
        }
